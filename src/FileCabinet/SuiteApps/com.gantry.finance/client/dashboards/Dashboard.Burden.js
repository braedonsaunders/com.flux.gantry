    ...
    const BurdenController = {
        ...
        renderDeptTrendChart: function() {
            ...
            if (viewType === 'composite') {
                ...
                var compositeHistory = history.compositeRate || [];
                ...
                categories.slice(0, 6).forEach(function(cat, i) {
                    var catTrend = trendData['cat_' + cat.id] || [];
                    if (catTrend.length > 0) {
                        traces.push({
                            x: labels,
                            y: catTrend,
                            type: 'scatter',
        ...
        validateFormula: function() {
            ...
            try {
                ...
                var result = window.GantryFormula ? window.GantryFormula.evaluate(evalFormula) : null;
                if (result === null || result === undefined) {
                    throw new Error('Formula preview unavailable');
                }
