...
2. Verify outbound HTTPS isn't blocked by firewall
3. Wait — the 24-hour grace period allows continued use
4. If persisting beyond 24 hours, contact support
...
1. **Email**: support@fluxfornetsuite.com
2. **Include**: Company name, issue description, screenshots, steps to reproduce
3. **Response time**: Typically within 1 business day
